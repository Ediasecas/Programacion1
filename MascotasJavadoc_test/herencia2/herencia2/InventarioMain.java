...
public class InventarioMain 
{
  ...
  */
    ...
    public static void main(String[] args) {
        ...
        i.getInventario().anadirMascota(nPerro);
        i.getInventario().anadirMascota(nGato);
        i.getInventario().anadirMascota(nLoro);
        i.getInventario().anadirMascota(nCanario);

        do {

            System.out.println("Seleccione una opcion del menu eligiendola por su número (1-8)");
            ...
            switch (seleccion) {
                ...
                case 4:
                    ...
                    i.getInventario().anadirMascota(nuevaMascota);
                    System.out.println("Nuevo animal anadido correctamente.");
