...
public class Main {
	...
	public static void main(String[] args) {
		...
		//EJERCICIO 13
					...
					int numv_ini = entrada.nextInt();
					
					System.out.println("Introduce el valor del incremento I");
					int num_incr = entrada.nextInt();
					
					System.out.println("Introduce tambien el numero N de valores a crear ");
					int num_n = entrada.nextInt();
					
					int[] array13 = new int[num_n];		
					
					for ( int i = numv_ini ; i < num_n ; num_incr++)
					...
					System.out.println("La secuencia aritmetica con V="+ numv_ini + " como "
							+ "valor inicial, con I="+ num_incr + " como incremento y "
							+ "con N="+ num_n + " valores a crear es ");
